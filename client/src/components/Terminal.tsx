      ...
      <div className="cyber-border scan-line p-2 sm:p-3 bg-gradient-to-r from-black via-gray-900 to-black">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="terminal-accent text-xs font-bold">
              ◉ SECURE CONNECTION
            </span>
        ...
        {terminalState.output.map((line, index) => (
              ...
              line.type === "error"
                ...
                : line.type === "prompt"
                  ...
                  : line.type === "command-title"
                    ? "mb-4 text-center text-lg sm:text-xl font-bold text-terminal-accent py-2 border-b border-terminal-accent font-\[0xProton\]"
          ...
          >
            {line.type === "command-title" ? (
              ...
              <>
                <pre className="hidden sm:block whitespace-pre-wrap text-xs sm:text-sm leading-relaxed font-['Ubuntu_Mono']">
                  {line.content}
                </pre>
                <pre className="sm:hidden whitespace-pre-wrap text-xs leading-relaxed font-['Ubuntu_Mono']">
                  {line.mobileContent}
                </pre>
              </>
            ) : (
              <pre className="whitespace-pre-wrap text-xs sm:text-sm leading-relaxed font-['Ubuntu_Mono']">
                {line.content}
              </pre>
            )}
          </div>
